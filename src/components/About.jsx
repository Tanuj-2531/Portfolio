...
const About = () => {
  ...
  return (
    <div className={`${theme === 'dark' ? 'bg-[#2d2d30] text-white' : 'bg-[#f4f3ef] text-[#111]'} h-full w-full p-20`} id='about'>
        ...
        <div className='grid grid-cols-2 p-11 h-full w-full gap-10'>
            <div className={`${aboutCardStyle} text-gray-900 h-114 p-10 rounded-3xl shadow-lg z-10`}>
            ...
            <div className={`${aboutCardStyle} h-114 p-11 rounded-3xl shadow-black/30 shadow-lg z-10`}>
                <h2 className='text-center text-2xl p-4 font-serif font-bold'>Skills</h2>
                <Skills />
            </div>
            <div className={`${aboutCardStyle} text-gray-900 h-114 p-10 rounded-3xl shadow-black/30 shadow-lg z-10`}>
